  ...
  return (
    <div className="w-full h-full flex flex-col max-w-[900px] mx-auto py-2 overflow-y-auto overflow-x-hidden">
      <div className="w-full bg-white/80 backdrop-blur-xl border border-white rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 md:p-12 mb-6">
        <h1 className="font-fraunces text-3xl font-bold text-ink-navy mb-4">Base Cover Letter</h1>
        ...
        {activeCoverLetter ? (
          <div className="bg-white/50 border border-white/80 rounded-2xl p-6 mb-8 flex items-start gap-4 shadow-sm w-full overflow-hidden">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-sm font-bold text-ink-navy uppercase tracking-wide mb-1">Active Cover Letter</h3>
              <p className="font-semibold text-lg text-ink-navy truncate mb-2">{activeCoverLetter.originalFilename}</p>
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-6 mb-8 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-sm font-bold text-ink-navy mb-1">No Cover Letter Uploaded</h3>
            <p className="text-xs text-ink-navy/60 max-w-xs">Upload your base cover letter to improve generated results.</p>
          </div>
        )}
