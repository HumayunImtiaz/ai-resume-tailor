  ...
  return (
    <div className="w-full h-full flex flex-col max-w-[900px] mx-auto py-2 overflow-y-auto overflow-x-hidden">
      <div className="w-full bg-white/80 backdrop-blur-xl border border-white rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 md:p-12 mb-6">
        <h1 className="font-fraunces text-3xl font-bold text-heading mb-4">Base Resume</h1>
        ...
        {activeResume ? (
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-2xl p-6 mb-8 flex flex-col items-center justify-center text-center">
            <FileText className="w-8 h-8 text-primary mb-3" />
            <h3 className="text-sm font-bold text-heading mb-1">No Resume Uploaded</h3>
            <p className="text-xs text-body max-w-xs">Upload your primary resume to start tailoring job applications.</p>
          </div>
        )}
